...
static uint32_t _calibration_iridix_ev_lim_no_str[] = {4722577, 3516186};

static uint8_t _calibration_ae_correction[] = {128, 128, 128, 128, 128, 128, 128, 128, 80, 60, 50, 50};

static uint32_t _calibration_ae_exposure_correction[] = {2415, 5276, 15778, 23282, 56186, 105328, 204819, 476749, 758847, 1513352, 2910958, 6838105};
...
static uint32_t _calibration_iridix8_strength_dk_enh_control[] = {
    ...
    1300,    // max_dk: maximum dark enhancement
...
static uint32_t _calibration_ae_control[] = {
    ...
    0,  // AE tail weight
    200,  // WDR mode only: Max percentage of clipped pixels for long exposure: WDR mode only: 256 = 100% clipped pixels
    ...
    98,  // control for clipping: highlights percentage (hi_target_prc): target for tail of histogram
...
static uint32_t _calibration_custom_settings_context[][4] = {
    ...
    //dp
    { 0x19298, 0x8000L, 0xffffff,4 }, //dp blend/dpdev threshold
    //Demosaic
    ...
    {0x1aa28, 0x7802L, 0x1f,1 }, //global offset [7:0]/Black Reflect/use_exp_mask/use LUT
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0 * 256, 96, 136, 160, 100, 20, 80, 8000, 8000, 4000, 100, 8000, 8000},
    {1 * 256, 96, 128, 160, 100, 20, 80, 8000, 8000, 4000, 100, 8000, 8000},
    {2 * 256, 96, 100, 160, 300, 20, 80, 7000, 7000, 4000, 100, 8000, 8000},
    {3 * 256, 96, 100, 160, 300, 20, 80, 7000, 7000, 4000, 100, 8000, 8000},
    {4 * 256, 96, 90, 160, 300, 40, 100, 7000, 7000, 4000, 100, 8000, 8000},
    {5 * 256, 96, 90, 160, 300, 80, 150, 7000, 7000, 4000, 80, 8000, 10000},
    {6 * 256, 96, 90, 160, 300, 80, 200, 6500, 6500, 4000, 60, 8000, 11000},
    {7 * 256, 96, 90, 160, 300, 80, 200, 6500, 6500, 4000, 30, 8000, 15000},
    {8 * 256, 96, 90, 160, 300, 100, 250, 6500, 6500, 4000, 30, 8000, 15000},
};
...
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0 * 256, 8, 180, 200, 809600},
    {1 * 256, 8, 180, 200, 809600},
    {2 * 256, 8, 180, 200, 809600},
    {3 * 256, 8, 180, 200, 809600},
    {4 * 256, 8, 180, 200, 809600},
    {5 * 256, 8, 180, 200, 809600},
    {6 * 256, 8, 180, 200, 809600},
    {7 * 256, 8, 180, 200, 809600},
};
...
uint32_t get_calibrations_dynamic_fs_lin_imx335( ACameraCalibrations *c );
uint32_t get_calibrations_dynamic_fs_lin_imx335( ACameraCalibrations *c )
{
    uint32_t result = 0;
    if ( c != 0 ) {
