...
static uint32_t _calibration_custom_settings_context[][4] = {
    ...
    //Demosaic
    { 0x1ae7c, 0x7db4bebeL, 0xffffffff,4 }, // UU Slope/VA Slope/AA Slope/VH Slope
    { 0x1ae84, 0x0c800b4L, 0xfff0fff,4 }, //AA Thresh/VH Thresh
    { 0x1ae88, 0x096015eL, 0xfff0fff,4 }, //UU Thresh/VA Thresh
    { 0x1aec0, 0x5596afL, 0xffffff,4 }, //grey det thresh/lg det thresh/UU SH Slope
    { 0x1aec8, 0x157c2134L, 0xffffffff,4 }, //grey det slope/lg det slope
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0 * 256, 150, 128, 175, 300, 320, 640, 7000, 7000, 4000, 4000, 8000, 8000},
    {1 * 256, 150, 128, 175, 300, 320, 640, 7000, 7000, 4000, 4000, 8000, 8000},
    {2 * 256, 150, 128, 175, 300, 320, 640, 7000, 7000, 4000, 4000, 8000, 8000},
    {3 * 256, 150, 128, 175, 300, 320, 640, 7000, 7000, 4000, 4000, 8000, 8000},
    {4 * 256, 150, 128, 175, 300, 320, 640, 7000, 7000, 4000, 4000, 8000, 8000},
    {5 * 256, 150, 128, 175, 300, 320, 640, 7000, 7000, 4000, 4000, 8000, 8000},
    {6 * 256, 150, 128, 175, 300, 320, 640, 7000, 7000, 4000, 4000, 8000, 8000},
    {7 * 256, 150, 128, 175, 300, 320, 640, 7000, 7000, 4000, 4000, 8000, 8000},
};
...
static uint32_t _calibration_fr_sharpen_extension_control[][6] = {
    ...
    {2 * 256, 10, 400, 1000, 1000, 1700},
    {3 * 256, 10, 400, 1000, 1000, 1700},
    {4 * 256, 10, 400, 1000, 1000, 1700},
    {5 * 256, 10, 400, 1000, 1000, 1700},
    {6 * 256, 10, 400, 1000, 1000, 1700},
    {7 * 256, 10, 400, 1000, 1000, 1700},
};
...
static uint32_t _calibration_cnr_extension_control[][20] = {
    ...
    {7 * 256, 1200, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 400, 5900, 0, 400, 5900},
};
...
uint32_t get_calibrations_dynamic_linear_imx307_demo( ACameraCalibrations *c );
uint32_t get_calibrations_dynamic_linear_imx307_demo( ACameraCalibrations *c )
{
    uint32_t result = 0;
    if ( c != 0 ) {
