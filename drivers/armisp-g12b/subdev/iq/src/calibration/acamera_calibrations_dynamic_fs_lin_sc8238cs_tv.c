...
static uint32_t _calibration_iridix_ev_lim_no_str[] = {3200000,2500000};
...
static uint32_t _calibration_iridix8_strength_dk_enh_control[] = {
    25,      // dark_prc
    95,      // bright_prc
    700,     // min_dk: minimum dark enhancement
    1200,    // max_dk: maximum dark enhancement
    ...
    3200,     // dark contrast min
    12800, // dark contrast max
    ...
    7680, // contrast_min: clip factor of strength for LDR scenes.
    10240, // contrast_max: clip factor of strength for HDR scenes.
    20,      // max iridix gain
    0        // print debug
};
...
static uint16_t _calibration_ae_control_HDR_target[][2] = {
    {0 * 256, 35}, // HDR AE target should not be higher than LDR target
    {1 * 256, 35},
    {2 * 256, 35},
    {3 * 256, 40},
    {4 * 256, 40},
...
static uint32_t _calibration_custom_settings_context[][4] = {
    ...
    //demosaic
    { 0x1ae7c, 0xaad2e6d7L, 0xffffffff,4 }, // UU Slope/VA Slope/AA Slope/VH Slope
    { 0x1ae84, 0x00820faL, 0xfff0fff,4 }, //AA Thresh/VH Thresh
    { 0x1ae88, 0x012c15eL, 0xfff0fff,4 }, //UU Thresh/VA Thresh
    { 0x1aec0, 0x0f0a96L, 0xffffff,4 }, //grey det thresh/lg det thresh/UU SH Slope
    { 0x1aec8, 0x75300bf7L, 0xffffffff,4 }, //grey det slope/lg det slope
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0 * 256, 150, 128, 170, 260, 50, 50, 8000, 8000, 4000, 4000, 8000, 8000},
    {1 * 256, 150, 128, 165, 260, 50, 100, 8000, 8000, 4000, 4000, 8000, 8000},
    {2 * 256, 150, 100, 160, 300, 50, 200, 7000, 7000, 4000, 4000, 8000, 8000},
    {3 * 256, 150, 100, 160, 300, 100, 500, 7000, 7000, 4000, 4000, 8000, 8000},
    {4 * 256, 150, 90, 160, 300, 500, 500, 7000, 7000, 4000, 4000, 8000, 8000},
    {5 * 256, 150, 90, 160, 300, 500, 500, 7000, 7000, 4000, 4000, 8000, 8000},
    {6 * 256, 150, 90, 160, 300, 500, 500, 6500, 6500, 4000, 4000, 8000, 8000},
    {7 * 256, 150, 90, 160, 300, 500, 500, 6500, 6500, 4000, 4000, 8000, 8000},
};
...
static uint32_t _calibration_cnr_extension_control[][20] = {
    {0 * 256, 1000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 800, 1000, 0, 800, 1000},
    {1 * 256, 1000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 800, 1000, 0, 800, 1000},
    {2 * 256, 1000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 800, 1000, 0, 800, 1000},
    {3 * 256, 1000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 800, 1000, 0, 800, 1000},
    {4 * 256, 1000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 800, 1000, 0, 800, 1000},
    {5 * 256, 1000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 800, 1000, 0, 800, 1000},
    {6 * 256, 1000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 800, 1000, 0, 800, 1000},
    {7 * 256, 1000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 62, 57000, 0, 800, 1000, 0, 800, 1000},
};

// { GAIN_LOG2_ID*256, svariance, bright_pr, contrast, white_level }
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0 * 256, 2, 160, 100, 409600},
    {1 * 256, 2, 160, 100, 409600},
    {2 * 256, 2, 160, 100, 409600},
    {3 * 256, 2, 160, 100, 409600},
    {4 * 256, 2, 160, 100, 409600},
    {5 * 256, 2, 160, 100, 409600},
    {6 * 256, 2, 160, 100, 409600},
    {7 * 256, 2, 160, 100, 409600},
};
...
uint32_t get_calibrations_dynamic_fs_lin_sc8238cs_tv( ACameraCalibrations *c );
uint32_t get_calibrations_dynamic_fs_lin_sc8238cs_tv( ACameraCalibrations *c )
{
    uint32_t result = 0;
    if ( c != 0 ) {
