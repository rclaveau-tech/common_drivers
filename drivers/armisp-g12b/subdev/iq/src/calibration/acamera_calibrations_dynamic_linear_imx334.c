...
static uint32_t _calibration_iridix_ev_lim_full_str[] = {1600000};

static uint32_t _calibration_iridix_ev_lim_no_str[] = {6500000, 4000000};
...
static uint32_t _calibration_iridix8_strength_dk_enh_control[] = {
    25,      // dark_prc
    95,      // bright_prc
    420,     // min_dk: minimum dark enhancement
    800,    // max_dk: maximum dark enhancement
    8,       // pD_cut_min: minimum intensity cut for dark regions in which dk_enh will be applied
    120,      // pD_cut_max: maximum intensity cut for dark regions in which dk_enh will be applied
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0*256, 150, 128, 165, 150, 10, 70, 7000, 7000, 4000, 100, 8000, 8000},
    {1*256, 150, 128, 165, 150, 10, 70, 7000, 7000, 4000, 100, 8000, 8000},
    {2*256, 150, 128, 160, 200, 50, 170, 7000, 7000, 4000, 100, 8000, 8000},
    {3*256, 150, 128, 155, 250, 100, 300, 7000, 7000, 4000, 80, 8000, 10000},
    {4*256, 150, 128, 155, 300, 150, 400, 7000, 5000, 4000, 70, 8000, 10000},
    {5*256, 150, 128, 155, 350, 150, 400, 7000, 6000, 4000, 50, 8000, 12000},
    {6*256, 150, 128, 155, 400, 150, 300, 7000, 6000, 4000, 50, 8000, 12000},
    {7*256, 150, 128, 155, 400, 150, 300, 7000, 6000, 4000, 40, 8000, 12000},
    {8*256, 150, 128, 155, 400, 200, 300, 7000, 6000, 4000, 40, 8000, 12000},
};
...
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0*256, 2, 170, 220, 500000},
    {1*256, 2, 170, 220, 500000},
    {2*256, 2, 160, 220, 500000},
...
uint32_t get_calibrations_dynamic_linear_imx334( ACameraCalibrations *c );
uint32_t get_calibrations_dynamic_linear_imx334( ACameraCalibrations *c )
{
    uint32_t result = 0;
    if ( c != 0 ) {
