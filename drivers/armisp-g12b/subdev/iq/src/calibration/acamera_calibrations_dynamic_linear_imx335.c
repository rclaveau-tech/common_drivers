...
static uint32_t _calibration_custom_settings_context[][4] = {
    ...
    { 0x1aeb4, 0x1edcL, 0x1fff,2 }, //min_d_strength
    { 0x1aeb8, 0x1edcL, 0x1fff,2 }, //min_ud_strength
    ...
    //CNR
    { 0x1b0f0, 0x5dcL, 0xfff,2 }, //global_offset
    { 0x1b0f4, 0x12cL, 0x0,2 }, //global_slope
    { 0x1b0fc, 0x258L, 0xfff,2 }, //uv_seg1_offset
    { 0x1b100, 0xd6d8L, 0x0,2 }, //uv_seg1_slope
    { 0x1b134, 0xfffL, 0xfff,2 }, //uv_var1_threshold
    { 0x1b138, 0xfffL, 0xfff,2 }, //uv_var1_offset
    { 0x1b13c, 0xff00L, 0x0,2 }, //uv_var1_slope
    { 0x1b140, 0xfffL, 0xfff,2 }, //uv_var2_threshold
    { 0x1b144, 0xfffL, 0xfff,2 }, //uv_var2_offset
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    ...
    {2 * 256, 96, 100, 160, 200, 50, 200, 10000, 10000, 4000, 100, 10000, 10000},
    {3 * 256, 96, 100, 160, 300, 100, 250, 10000, 10000, 4000, 100, 10000, 10000},
    {1 * 896, 96, 90, 160, 300, 500, 250, 10000, 10000, 4000, 100, 10000, 10000},
    {4 * 256, 96, 90, 160, 300, 500, 500, 10000, 10000, 4000, 100, 10000, 10000},
    {1 * 1152, 96, 90, 160, 300, 600, 600, 10000, 10000, 4000, 50, 8000, 10000},
    {5 * 256, 96, 90, 160, 400, 700, 700, 10000, 10000, 4000, 50, 8000, 10000},
    {1 * 1408, 96, 90, 160, 400, 700, 700, 10000, 10000, 4000, 50, 8000, 10000},
};
...
static uint32_t _calibration_fr_sharpen_extension_control[][6] = {
    {0 * 256, 10, 200, 800, 1000, 1700},
    {1 * 256, 10, 200, 800, 1000, 1700},
    {2 * 256, 10, 200, 800, 1000, 1700},
    {3 * 256, 10, 300, 800, 1000, 1700},
    {1 * 896, 10, 300, 800, 1000, 1700},
    {4 * 256, 10, 300, 800, 1000, 1700},
    {1 * 1152, 10, 300, 800, 1000, 1700},
    {5 * 256, 10, 300, 800, 1000, 1700},
    {1 * 1408, 10, 300, 800, 1000, 1700},
};
...
static uint32_t _calibration_ds_sharpen_extension_control[][6] = {
    ...
    {1 * 896, 10, 200, 1000, 1000, 1700},
    {4 * 256, 10, 200, 1000, 1000, 1700},
    {1 * 1152, 10, 200, 1000, 1000, 1700},
    {5 * 256, 10, 200, 1000, 1000, 1700},
    {1 * 1408, 10, 200, 1000, 1000, 1700},
};
...
static uint32_t _calibration_cnr_extension_control[][20] = {
    {0 * 256, 1000, 0, 200, 57000, 0, 200, 57000, 0, 20, 57000, 0, 20, 57000, 0, 100, 4000, 0, 100, 4000},
    {1 * 256, 1000, 0, 200, 57000, 0, 200, 57000, 0, 20, 57000, 0, 20, 57000, 0, 100, 4000, 0, 100, 4000},
    {2 * 256, 1000, 0, 180, 57000, 0, 180, 57000, 0, 40, 57000, 0, 40, 57000, 0, 100, 4000, 0, 100, 4000},
    {3 * 256, 1000, 0, 180, 57000, 0, 180, 57000, 0, 40, 57000, 0, 40, 57000, 0, 100, 4000, 0, 100, 4000},
    {1 * 896, 1000, 0, 160, 57000, 0, 160, 57000, 0, 60, 57000, 0, 60, 57000, 0, 100, 6000, 0, 100, 6000},
    {4 * 256, 1000, 0, 160, 57000, 0, 160, 57000, 0, 60, 57000, 0, 60, 57000, 0, 100, 8000, 0, 100, 8000},
    {1 * 1152, 1000, 0, 140, 57000, 0, 140, 57000, 0, 80, 57000, 0, 80, 57000, 0, 100, 10000, 0, 100, 10000},
    {5 * 256, 1000, 0, 120, 57000, 0, 120, 57000, 0, 100, 57000, 0, 100, 57000, 0, 100, 14000, 0, 100, 14000},
    {1 * 1408, 1000, 0, 120, 57000, 0, 120, 57000, 0, 120, 57000, 0, 120, 57000, 0, 100, 16000, 0, 100, 16000},
};

// { GAIN_LOG2_ID*256, svariance, bright_pr, contrast, white_level }
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0 * 256, 2, 220, 230, 809600},
    {1 * 256, 2, 220, 230, 809600},
    {2 * 256, 2, 220, 230, 809600},
    {3 * 256, 2, 220, 230, 809600},
    {1 * 896, 2, 220, 230, 809600},
    {4 * 256, 2, 220, 230, 809600},
    {1 * 1152, 2, 220, 230, 809600},
    {5 * 256, 2, 220, 230, 809600},
    {1 * 1408, 2, 220, 230, 809600},
};
