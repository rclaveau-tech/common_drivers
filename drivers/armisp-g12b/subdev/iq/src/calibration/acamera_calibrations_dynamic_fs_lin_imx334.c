...
static uint32_t _calibration_iridix_ev_lim_no_str[] = {5180000,2500000};
...
static uint32_t _calibration_ae_control[] = {
    ...
    30,  // control for clipping: highlights percentage (hi_target_prc): target for tail of histogram
...
static uint8_t _calibration_pf_radial_lut[] = {100, 180, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255};
...
static uint32_t _calibration_custom_settings_context[][4] = {
    ...
    //CNR
    { 0x1b0d0, 0x0L, 0x1,1 }, //square_root_enable
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0*256, 150, 128, 170, 150, 100, 200, 8000, 8000, 4000, 150, 8000, 4000},
    {1*256, 150, 128, 170, 200, 150, 250, 8000, 8000, 4000, 150, 8000, 5000},
    {2*256, 150, 128, 160, 250, 150, 250, 8000, 8000, 4000, 125, 8000, 6000},
    {3*256, 150, 128, 160, 250, 150, 250, 8000, 8000, 4000, 125, 8000, 6000},
    {4*256, 150, 120, 150, 250, 150, 250, 8000, 8000, 4000, 125, 8000, 8000},
    {5*256, 150, 120, 150, 300, 200, 300, 8000, 8000, 4000, 100, 8000, 10000},
    {6*256, 150, 120, 150, 300, 200, 300, 8000, 8000, 4000, 80, 8000, 10000},
    {7*256, 150, 120, 150, 300, 200, 300, 8000, 8000, 4000, 80, 8000, 12000},
    {8*256, 150, 120, 150, 300, 200, 300, 8000, 8000, 4000, 80, 8000, 15000},
};
...
static uint32_t _calibration_cnr_extension_control[][20] = {
    {0*256, 50, 0, 30, 10000, 0, 30, 10000, 0, 30, 10000, 0, 30, 10000, 0, 100, 7500, 0, 100, 7500},
    {1*256, 50, 0, 30, 10000, 0, 30, 10000, 0, 30, 10000, 0, 30, 10000, 0, 100, 7500, 0, 100, 7500},
    {2*256, 50, 0, 30, 10000, 0, 30, 10000, 0, 30, 10000, 0, 30, 10000, 0, 100, 7500, 0, 100, 7500},
    ...
    {8*256, 10, 0, 10, 1000, 0, 10, 1000, 0, 10, 1000, 0, 10, 1000, 0, 200, 12000, 0, 200, 12000},
};

// { GAIN_LOG2_ID*256, svariance, bright_pr, contrast, white_level }
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0*256, 8, 180, 210, 450000},
    {1*256, 10, 180, 210, 450000},
    {2*256, 10, 180, 210, 450000},
    {3*256, 10, 180, 210, 450000},
    {4*256, 10, 180, 210, 450000},
    {5*256, 10, 180, 210, 450000},
    {6*256, 2, 180, 210, 450000},
    {7*256, 2, 180, 210, 450000},
    {8*256, 2, 180, 210, 450000},
};
...
uint32_t get_calibrations_dynamic_fs_lin_imx334( ACameraCalibrations *c );
uint32_t get_calibrations_dynamic_fs_lin_imx334( ACameraCalibrations *c )
{
    uint32_t result = 0;
    if ( c != 0 ) {
