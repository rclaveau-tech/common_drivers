...
static ssize_t show_fan_enable(const struct class *cls,
			 const struct class_attribute *attr, char *buf)
{
	return sprintf(buf, "Fan enable: %d\n", g_mcu_data->fan_data.enable);
}

static ssize_t store_fan_enable(const struct class *cls, const struct class_attribute *attr,
...
static ssize_t show_fan_mode(const struct class *cls,
			 const struct class_attribute *attr, char *buf)
{
	return sprintf(buf, "Fan mode: %d\n", g_mcu_data->fan_data.mode);
}

static ssize_t store_fan_mode(const struct class *cls, const struct class_attribute *attr,
		       const char *buf, size_t count)
{
	int mode;
...
static ssize_t show_fan_level(const struct class *cls,
			 const struct class_attribute *attr, char *buf)
{
	return sprintf(buf, "Fan level: %d\n", g_mcu_data->fan_data.level);
}

static ssize_t store_fan_level(const struct class *cls, const struct class_attribute *attr,
		       const char *buf, size_t count)
{
	int level;
...
static ssize_t show_fan_temp(const struct class *cls,
			 const struct class_attribute *attr, char *buf)
{
	struct mcu_fan_data *fan_data = &g_mcu_data->fan_data;
	int temp = -EINVAL;
...
static void fan_level_set(struct mcu_data *ug_mcu_data)
{
	struct mcu_fan_data *fan_data = &g_mcu_data->fan_data;
	int temp = -EINVAL;
...
static ssize_t show_fan_trigger_low(const struct class *cls,
		const struct class_attribute *attr, char *buf)
{
	return sprintf(buf,
...
static ssize_t store_fan_trigger_low(const struct class *cls,
...
static ssize_t show_fan_trigger_mid(const struct class *cls,
		const struct class_attribute *attr, char *buf)
{
	return sprintf(buf,
...
static ssize_t store_fan_trigger_mid(const struct class *cls,
		const struct class_attribute *attr,
		const char *buf, size_t count)
{
	int trigger;
...
static ssize_t show_fan_trigger_high(const struct class *cls,
		const struct class_attribute *attr, char *buf)
{
	return sprintf(buf,
...
static ssize_t store_fan_trigger_high(const struct class *cls,
		const struct class_attribute *attr,
		const char *buf, size_t count)
{
	int trigger;
...
static ssize_t store_mcu_poweroff(const struct class *cls,
		const struct class_attribute *attr,
		const char *buf, size_t count)
{
	int ret;
...
static ssize_t store_mcu_rst(const struct class *cls, const struct class_attribute *attr,
		const char *buf, size_t count)
{
	char reg;
	int ret;
...
static ssize_t store_wol_enable(const struct class *cls, const struct class_attribute *attr,
								const char *buf, size_t count)
{
	u8 reg[2];
	int ret;
...
static ssize_t show_wol_enable(const struct class *cls,
				const struct class_attribute *attr, char *buf)
{
	int enable;
...
static ssize_t store_usb_pcie_switch_mode(const struct class *cls, const struct class_attribute *attr,
				const char *buf, size_t count)
{
	int ret;
	int mode;
...
static ssize_t show_usb_pcie_switch_mode(const struct class *cls,
				const struct class_attribute *attr, char *buf)
{
...
static void create_mcu_attrs(void)
{
	...
	if (is_mcu_wol_supported()) {
			g_mcu_data->wol_class = class_create("wol");
	...
	g_mcu_data->mcu_class = class_create("mcu");
