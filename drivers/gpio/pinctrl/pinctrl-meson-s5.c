...
static struct meson_pmx_group meson_s5_periphs_groups[] __initdata = {
	GPIO_GROUP(GPIOD_0),
	GPIO_GROUP(GPIOD_1),
	GPIO_GROUP(GPIOD_2),
	GPIO_GROUP(GPIOD_3),
...
static struct meson_pmx_group meson_s5_storage_groups[] __initdata = {
	GPIO_GROUP(GPIOB_0),
	GPIO_GROUP(GPIOB_1),
	GPIO_GROUP(GPIOB_2),
	GPIO_GROUP(GPIOB_3),
...
static struct meson_pmx_func meson_s5_storage_functions[] __initdata = {
	FUNCTION(gpio_storage),
	FUNCTION(emmc),
	FUNCTION(spif),
};

static struct meson_pmx_func meson_s5_periphs_functions[] __initdata = {
...
static struct meson_pinctrl_data meson_s5_storage_pinctrl_data __refdata = {
	.name		= "storage-banks",
...
static struct meson_pinctrl_data meson_s5_periphs_pinctrl_data __refdata = {
	.name		= "periphs-banks",
...
module_init(meson_s5_pinctrl_init);
#endif
