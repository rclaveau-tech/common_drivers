...
static const struct pinctrl_pin_desc meson_t3x_analog_pins[] = {
	MESON_PIN(CDAC_IOUT),
	MESON_PIN(CVBS0),
	MESON_PIN(CVBS1),
...
static struct meson_pmx_group meson_t3x_analog_groups[] __initdata = {
...
static struct meson_pmx_func meson_t3x_analog_functions[] __initdata = {
	FUNCTION(gpio_analog)
};

static const struct pinctrl_pin_desc meson_t3x_periphs_pins[] = {
	MESON_PIN(GPIOW_0),
	MESON_PIN(GPIOW_1),
	MESON_PIN(GPIOW_2),
	MESON_PIN(GPIOW_3),
...
static const unsigned int pcieck_reqn_d_pins[]		= { GPIOD_12 };
...
static const unsigned int spi4_mosi_c_pins[]		= { GPIOC_4 };
...
static const unsigned int spi0_ss1_h26_pins[]		= { GPIOH_26 };
...
static const unsigned int spi4_miso_p_pins[]		= { GPIOP_7 };
...
static const char * const uart_c_groups[] = {
	...
	"uart_c_tx_h28", "uart_c_rx_h29", "uart_c_cts_h22", "uart_c_rts_h23",
...
static const char * const tdm_groups[] = {
	...
	"tdm_fs1_h18", "tdm_fs2_h28", "tdm_fs2_h23", "tdm_sclk2_p",
	"tdm_sclk2_m", "tdm_sclk1_m", "tdm_sclk2_h29", "tdm_sclk2_h22"
};
...
static const char * const spi4_groups[] = {
	...
	"spi4_ss0_p", "spi4_mosi_c", "spi4_mosi_p"
};
...
static const char * const pcieck_groups[] = {
	"pcieck_reqn_d", "pcieck_reqn_c", "pcieck_reqn_p",
	"pcieck_reqn_m"
};
...
static struct meson_bank meson_t3x_analog_banks[] = {
	BANK("ANALOG", CDAC_IOUT, CVBS1,   151, 153,
	     0,  31, 0, 30, 1, 0, 0, 30, 0, 0),
	BANK("ANALOG", SARADC_CH0_IO, SARADC_CH4_IO,  -1, -1,
	     0,  29, 0, 28, 0, 27, 0, 26, 0, 25)
};

static struct meson_pmx_bank meson_t3x_analog_pmx_banks[] = {
	BANK_PMX("ANALOG", CDAC_IOUT, CVBS1, 0x0, 29),
	BANK_PMX("ANALOG", SARADC_CH0_IO, SARADC_CH4_IO, 0x0, 29)
};

static struct meson_axg_pmx_data meson_t3x_analog_pmx_banks_data = {
	.pmx_banks	= meson_t3x_analog_pmx_banks,
	.num_pmx_banks	= ARRAY_SIZE(meson_t3x_analog_pmx_banks),
};
...
static struct meson_bank meson_t3x_periphs_banks[] = {
	...
	BANK_DS("P",    GPIOP_0,    GPIOP_9,  140, 149,
...
static struct meson_pinctrl_data meson_t3x_analog_pinctrl_data __refdata = {
	.name		= "analog-banks",
	.pins		= meson_t3x_analog_pins,
	.groups		= meson_t3x_analog_groups,
	.funcs		= meson_t3x_analog_functions,
	.banks		= meson_t3x_analog_banks,
	.num_pins	= ARRAY_SIZE(meson_t3x_analog_pins),
	.num_groups	= ARRAY_SIZE(meson_t3x_analog_groups),
	.num_funcs	= ARRAY_SIZE(meson_t3x_analog_functions),
	.num_banks	= ARRAY_SIZE(meson_t3x_analog_banks),
	.pmx_ops	= &meson_axg_pmx_ops,
	.pmx_data	= &meson_t3x_analog_pmx_banks_data,
	.parse_dt	= meson_g12a_aobus_parse_dt_extra,
};

static struct meson_pinctrl_data meson_t3x_periphs_pinctrl_data __refdata = {
	.name		= "periphs-banks",
	.pins		= meson_t3x_periphs_pins,
	.groups		= meson_t3x_periphs_groups,
	.funcs		= meson_t3x_periphs_functions,
	.banks		= meson_t3x_periphs_banks,
	.num_pins	= ARRAY_SIZE(meson_t3x_periphs_pins),
...
static const struct of_device_id meson_t3x_pinctrl_dt_match[] = {
	{
		.compatible = "amlogic,meson-t3x-periphs-pinctrl",
		.data = &meson_t3x_periphs_pinctrl_data,
	},
	{
		.compatible = "amlogic,meson-t3x-analog-pinctrl",
		.data = &meson_t3x_analog_pinctrl_data,
	},
	{ }
};

static struct platform_driver meson_t3x_pinctrl_driver = {
	.probe  = meson_pinctrl_probe,
	.driver = {
		.name	= "meson-t3x-pinctrl",
		.of_match_table = meson_t3x_pinctrl_dt_match,
	},
};

#ifndef MODULE
static int __init t3x_pmx_init(void)
{
	meson_t3x_pinctrl_driver.driver.of_match_table =
			meson_t3x_pinctrl_dt_match;
	return platform_driver_register(&meson_t3x_pinctrl_driver);
}
arch_initcall(t3x_pmx_init);

#else
int __init meson_t3x_pinctrl_init(void);
int __init meson_t3x_pinctrl_init(void)
{
	meson_t3x_pinctrl_driver.driver.of_match_table =
			meson_t3x_pinctrl_dt_match;
...
module_init(meson_t3x_pinctrl_init);
#endif
