...
int kbase_csf_scheduler_init(struct kbase_device *kbdev)
{
	...
	hrtimer_setup(&scheduler->gpu_metrics_timer, &gpu_metrics_timer_callback, CLOCK_MONOTONIC, HRTIMER_MODE_REL_SOFT);
